...
@endsection
@section('content')
    <div class="relative lg:h-screen h-[70vh]" style="background: url({{asset('/get-in-touch.webp')}});background-position: center;background-size: cover">
        <div
            ...
            <div class="max-w-4xl px-4 lg:px-0 flex flex-col gap-8">
                <h1 class="text-3xl lg:text-5xl font-black">Get in Touch </h1>
    ...
    <div class="max-w-7xl flex flex-col gap-8 mx-auto  text-center py-24">
        <h1 class="text-3xl lg:text-5xl font-light uppercase">Signature <span class="font-black">Digital</span></h1>
        <p>
