...
@section('content')
    <div class="relative lg:h-screen h-[70vh]"
        ...
        <div
            ...
            <div class="max-w-4xl px-4 lg:px-0 flex flex-col gap-8">
                <h1 class="text-4xl lg:text-5xl font-black">Get in Touch </h1>
    ...
    <div
        class="max-w-7xl px-4 lg:px-0 flex flex-col gap-8 mx-auto font-black text-lg uppercase text-center py-12 lg:py-24">
    ...
    <div class="max-w-7xl flex flex-col gap-8 mx-auto  text-center px-4 lg:px-0 py-12 lg:py-24">
        <h1 class="text-4xl lg:text-5xl font-black uppercase">Signature Digital</h1>
        <p>
