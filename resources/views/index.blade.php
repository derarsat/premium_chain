   ...
   <main class="grid grid-cols-1 gap-12 lg:gap-24">
       ...
       <div class="max-w-5xl px-4 lg:px-0 mx-auto grid grid-cols-1 gap-4">
           ...
           <p class="text-center mt-2">
               ...
               With various projects in the food and beverage industry, Premium Chain provides businesses with consulting
               services that include branding, design, operations, human resources, research and development, franchising,
               and procurement.
       ...
       <div class="max-w-7xl mx-auto px-4 lg:px-0">
           <img class="min-h-[300px] max-w-full" src="{{asset("/skyline.webp")}}" alt="">
       </div>
       <x-locations/>
       <div class="max-w-5xl px-4 lg:px-0  mx-auto">
           ...
           <p class="text-center mt-2">Premium Chain can provide businesses with the following services to grow and find
               success. </p>
           <div class="max-w-5xl mx-auto px-0 lg:px-4 lg:px-0 grid grid-cols-1 lg:grid-cols-2">
               <img src="{{asset("/consultancy-card.webp")}}" alt="Premium Chain Consultancy">
