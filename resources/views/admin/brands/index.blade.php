    ...
    <ul class="flex flex-wrap -mb-px font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent"
        ...
        <li class="mr-2" role="presentation">
            ...
            <button class="inline-block p-4 border-b-2 rounded-t-lg" id="brands-tab"
                data-tabs-target="#brands-hero-images" type="button" role="tab" aria-controls="brands-hero-images"
                aria-selected="false">
                Brands Hero Images
            </button>
        </li>
        <li class="mr-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg" id="countries-tab" data-tabs-target="#countries"
