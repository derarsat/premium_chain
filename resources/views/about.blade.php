...
@section("content")
    ...
    <div class="grid grid-cols-1 gap-12 lg:gap-24">
            ...
            <div style="background-image: url({{asset('/tr-bg.png')}})" class="px-4 py-24 lg:px-0 max-w-7xl mx-auto">
                <div class=" w-full lg:w-6/12 flex justify-end gap-6 flex-col ml-auto">
                    ...
                    <p>
                        ...
                        catering, event production, concept development, and menu planning, among others. Owning,
                        Operating,
                        and
                        Managing branches in four countries at the moment.
                        <br>
                        <br>
                        As a strategic partner to the General Entertainment Authority and SELA (Sports, Entertainment,
                        and
                        Culture), the chain has contributed to the success of numerous events in Saudi Arabia. The
                        company has played a significant role in the organization of the Riyadh Season and Jeddah
                        Seasons,
                        as
                        ...
                        The company is dedicated to providing customized solutions to meet the unique needs and
                        preferences
                        of
                        each client.
                    </p>
        ...
        {{--        --}}
        <!--  -->
        <div class="bg-[#576871] text-white py-12 lg:p-24" style="background-image: url({{asset('/misson-bg.webp')}})">

            <div class="max-w-3xl mx-auto px-4 lg:px-0 text-center">
                <h1 class="text-4xl lg:text-5xl font-medium mb-6"><span class="font-light">OUR</span> MISSION</h1>
                <p>Building a team of hospitality professionals armed with the latest technology and a culture of
                    inclusion,
                    to accrue the lion share of the Middle eastern offering in the market.</p>
            </div>
        </div>
        <!--  -->
        <div class=" max-w-7xl text-center mx-auto px-4 lg:px-0 grid grid-cols-1 gap-8 pb-12">
            ...
            <p class="">
                ...
                from the hospitality industry, including chefs, managers, and marketers, who work closely with clients
                to
        ...
        <div class="max-w-7xl text-center mx-auto px-4 lg:px-0 grid grid-cols-1 gap-8 mb-12 ">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-24  py-24 ">
                ...
                <p class="text-left">
                    ...
                    means of not only giving back to create a culture of support to all employees. Being one of the
                    leading
                    ...
                    community. The program is designed to support various social causes through different activities.
                    These
                    activities are centered on giving food to the needy, feeding orphans during Islamic holidays,
                    inviting
                    elderly from home centers, helping war victims abroad, and planting trees around the world.
                    Supporting
